...
\`\`\`𝐀𝐏𝐑𝐎𝐕𝐄𝐈𝐓𝐀𝐍 𝐎 𝐁𝐎𝐓 𝐀𝐄 𝐁𝐀𝐀𝐇\`\`\`
\`\`\`𝐌𝐄𝐔 𝐂𝐀𝐍𝐀𝐋 𝐁𝐀𝐇: https://youtube.com/channel/UCRcEwc3vkj9EL8oziwW4R7w\`\`\`
...
͏͏͏͏͏͏͏͏͏͏͏͏͏͏╭──────「 *𝐌𝐈𝐃𝐈𝐀 𝐃𝐎𝐖𝐍𝐋𝐎𝐀𝐃𝐄𝐑* 」
┴
...
│➻ *${prefix}nulis Sadzin /Bot*
│
│➻ *${prefix}tahta SADZIN*
│➻ *${prefix}croman SADZINN dan BOT*
│➻ *${prefix}clove SADZIN*
│➻ *${prefix}cparty SADZIN*
│➻ *${prefix}csky SADZIN*
│➻ *${prefix}tts id Haii*
│➻ *${prefix}ttp SADZIN [ERRO]*
│➻ *${prefix}cballon SADZIN*
│➻ *${prefix}cpaper SADZIN*
│➻ *${prefix}slide SADZIN BOT WA*
│
│➻ *${prefix}stiker*
│➻ *${prefix}gifstiker*
│➻ *${prefix}toimg*
